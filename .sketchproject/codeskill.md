...
use:
  ...
  * run\_in\_terminal / run tasks for builds and tests
...
examples: |
* "Fix failing import in src/conveyer\_2/aiCore.js and add a unit test."
...
* "Use the All-Around Assistant to refactor `src/conveyer\_2/aiCore.js` for clarity."
